#include <Arduino.h>
    ...
    //commented lines are for the second and third multiplexer, current setup tests only the first one
    ...
    const uint8_t kMUXPin1_1 = 2; 
    const uint8_t kMUXPin2_1 = 3;
    const uint8_t kMUXPin3_1 = 4;
    ...
    // const uint8_t kSignalPin3 = A0;
    // const uint8_t kMUXPin1_3 = 2;
    // const uint8_t kMUXPin2_3 = 3;
    // const uint8_t kMUXPin3_3 = 4;
