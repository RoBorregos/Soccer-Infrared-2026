...
void printSummary() {
    ...
    Serial.println();
    Serial.println(F("--------------------------------"));
    Serial.print(F("kPhotoTresholdLeft  = ")); Serial.print(cal_left.threshold);  Serial.println(F(";"));
    Serial.print(F("kPhotoTresholdRight = ")); Serial.print(cal_right.threshold); Serial.println(F(";"));
    Serial.print(F("kPhotoTresholdFront = ")); Serial.print(cal_front.threshold); Serial.println(F(";"));
    Serial.println();
    Serial.println(F("============================================"));
}
